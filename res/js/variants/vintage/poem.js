$(document).ready(function() {
        var itemsD = ["S", "M", "M", "L", "L", "L", "L"];
        var itemsA = ["S", "M", "M", "M", "M", "M", "XL", "XL", "XL"];
        var items = [];
        var index = 1;
        var size = 7;
        var type = "distressed";
        ...
        var shopClient = ShopifyBuy.buildClient({
            ...
            $("#cartGridFinal1, #cartGridFinal1Mobile").click(function(event) {
                // alert($("#index").text());
                shopClient.fetchProduct('10593537928')
    ...
    $("#distressed, #distressedMobile, #archived, #archivedMobile").click(function(event) {
        ...
        $("#vintageFeature").css({"background-image":"url(/images/shop/product/vintage/poem/"+type+"/"+index+".png)"});
        $("#vintageFeatureMobile").css({"background-image":"url(/images/shop/product/vintage/poem/mobile/"+type+"/"+index+".png)"});
