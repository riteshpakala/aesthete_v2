$(document).ready(function() {
        var itemsD = ["M", "M", "M", "L", "L", "L"];
        var itemsA = ["S", "S", "S", "S", "M", "L", "L", "L", "XL", "XL"];
        var items = [];
        var index = 1;
        var size = 6;
        var type = "distressed";
         ...
         var shopClient = ShopifyBuy.buildClient({
            ...
            $("#cartGridFinal1, #cartGridFinal1Mobile").click(function(event) {
                // alert($("#index").text());
                shopClient.fetchProduct('10593324872')
    ...
    $("#distressed, #distressedMobile, #archived, #archivedMobile").click(function(event) {
        ...
        $("#vintageFeature").css({"background-image":"url(/images/shop/product/vintage/jenesaisquoi/"+type+"/"+index+".png)"});
        $("#vintageFeatureMobile").css({"background-image":"url(/images/shop/product/vintage/jenesaisquoi/mobile/"+type+"/"+index+".png)"});
